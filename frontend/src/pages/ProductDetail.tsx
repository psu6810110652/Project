                                        ...
                                        {displayImages.slice(0, 5).map((image, index) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`relative aspect-square border-2 rounded-lg bg-gray-100 flex items-center justify-center cursor-pointer overflow-hidden transition-all ${
                                                        index === selectedImageIndex && !isLastAndMore ? 'border-[#2a6b3b]' : 'border-transparent hover:border-gray-300'
                                                    }`}
                                                >
                            ...
                            {displayImages.map((image, idx) => (
                                <div 
                                    ...
                                    className={`aspect-square rounded-xl overflow-hidden border-2 cursor-pointer ${
                                        idx === selectedImageIndex ? 'border-[#2a6b3b]' : 'border-transparent hover:border-gray-300'
                                    }`}
                                >
                                    {image && image.includes('/api/placeholder/') ? (
